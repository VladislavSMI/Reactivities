...
namespace Application.Photos
{
  public class Delete
  {
    // Returning Unit means that we are actutally returning anything
    ...
    public class Handler : IRequestHandler<Command, Result<Unit>>
    {
      ...
      public async Task<Result<Unit>> Handle(Command request, CancellationToken cancellationToken)
      {
        ...
        // We are not using here async because we have already retrieved User from our db and included photo collection so in memory we should have access to the Photos
